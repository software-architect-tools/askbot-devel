...
DEBUG = os.environ['DJANGO_DEBUG']  # set to True to enable debugging
TEMPLATE_DEBUG = False  # keep false when debugging jinja2 templates
INTERNAL_IPS = ('127.0.0.1',)
ALLOWED_HOSTS = ['*',]#change this for better security on your site

ADMINS = (
    (os.environ['ADMIN_ALIAS'], os.environ['ADMIN_EMAIL']),
)
...
# LOG_LEVEL = os.environ['LOG_LEVEL'] or 'INFO' # CRITICAL, DEBUG, INFO
LOG_LEVEL = 'INFO' # CRITICAL, DEBUG, INFO
logging.basicConfig(
...
formatter = logging.Formatter('%(pathname)s TIME: %(asctime)s MSG: %(filename)s:%(funcName)s:%(lineno)d %(message)s')
